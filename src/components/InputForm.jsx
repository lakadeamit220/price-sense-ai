          ...
          {isCompareMode && (
            ...
            >
              <div className="flex justify-between items-center pt-2">
                <label className="block text-sm font-bold text-primary-700 dark:text-primary-400">Scenario B Discount</label>
                <div className="relative w-24">
                  <input 
                    type="number" 
                    min="5" 
                    ...
                    className="block w-full pr-7 py-1.5 text-sm font-semibold text-right border-primary-200 dark:border-primary-800 rounded-lg focus:ring-primary-500 dark:focus:ring-primary-400 focus:border-primary-500 dark:focus:border-primary-400 border bg-primary-50 dark:bg-primary-900/30 outline-none shadow-sm text-primary-900 dark:text-primary-100"
                  />
                  <div className="absolute inset-y-0 right-0 pr-2.5 flex items-center pointer-events-none">
                    <span className="text-primary-500 dark:text-primary-400 text-sm font-medium">%</span>
                  </div>
                </div>
              </div>
              <input 
                ...
                value={discountB}
                onChange={(e) => setDiscountB(Number(e.target.value))}
                className="w-full h-2.5 bg-primary-100 dark:bg-primary-900/50 rounded-full appearance-none cursor-pointer accent-primary-600 dark:accent-primary-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:focus:ring-offset-slate-900"
              />
              <div className="flex justify-between text-xs text-primary-400 dark:text-primary-500/70 font-semibold px-1">
                <span>5%</span>
                <span>70%</span>
              </div>
            </motion.div>
